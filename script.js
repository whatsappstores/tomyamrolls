...
const MENU = [
  ...
  },
  {
    ...
    items: [
      { id: "rl1", name: "Ролл «Креветка темпура острый»", desc: "Креветка темпура, творожный сыр, авокадо, айсберг, икра тобико, стружка тунца, соусы спайси и унаги, перец чили", weight: "270 г / 8 шт", price: 600 },
      ...
      { id: "rl5", name: "Ролл «Классический»", desc: "Лосось, сурими, огурец, авокадо, айсберг, творожный сыр, сыр чеддер, икра тобико, соусы ореховый и унаги, кунжут", weight: "270 г / 8 шт", price: 695 },
      { id: "rl6", name: "Филадельфия классический", desc: "Творожный сыр, огурец, лосось", weight: "250 г", price: 595 },
      { id: "rl7", name: "Ролл с креветкой", desc: "Креветка, соус спайси, икра тобико, айсберг, авокадо, стружка бонито", weight: "250 г", price: 537 },
  ...
  },
  {
    ...
    items: [
      { id: "tp1", name: "Темпура с сурими", desc: "Сурими в хрустящей панировке, огурец, творожный сыр, морковь, айсберг, икра тобико, соусы спайси и унаги", weight: "280 г / 8 шт", price: 575 },
      { id: "tp2", name: "Темпура с лососем", desc: "Лосось в хрустящей панировке, огурец, творожный сыр, морковь, айсберг, икра тобико, соусы спайси и унаги", weight: "280 г / 8 шт", price: 580 },
      { id: "tp3", name: "Темпура с угрём", desc: "Угорь в хрустящей панировке, огурец, творожный сыр, морковь, айсберг, икра тобико, соусы спайси и унаги", weight: "280 г / 8 шт", price: 593 },
      { id: "tp4", name: "Темпура с курицей", desc: "Курица в хрустящей панировке, творожный сыр, огурец, айсберг, морковь, икра тобико, соус унаги", weight: "280 г / 8 шт", price: 550 }
    ]
  },
  {
    cat: "baked", catLabel: "Запечённые роллы", glyph: "🧀",
    items: [
      { id: "bk1", name: "Запечённый с лососем", desc: "Лосось, творожный сыр, огурец, сурими, морковь, икра тобико, зелёный лук, сыр гауда, сырный соус, соус унаги, кунжут белый", weight: "300 г / 8 шт", price: 686 },
      { id: "bk2", name: "Запечённый с курицей", desc: "Курица, творожный сыр, огурец, сурими, морковь, икра тобико, зелёный лук, сыр гауда, сырный соус, соус унаги, кунжут белый", weight: "300 г / 8 шт", price: 642 }
    ]
  },
  {
    cat: "hotdogs", catLabel: "Хот-доги", glyph: "🌭",
    items: [
      { id: "hd1", name: "Хот-дог с курицей", desc: "Творожный сыр, икра тобико, манго свежий, шпинат, айсберг, помидор, зелёный лук, курица, сырный соус, сыр гауда, соус спайс; соус унаги подаётся отдельно, 30 г", weight: "250 г", price: 667 },
      { id: "hd2", name: "Хот-дог с лососем", desc: "Творожный сыр, икра тобико, манго свежий, шпинат, айсберг, помидор, зелёный лук, лосось, сырный соус, сыр гауда, соус спайс; соус унаги подаётся отдельно, 30 г", weight: "250 г", price: 698 }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: "se6", name: "Сет с манго", desc: "Манго ролл, Манго эби темпура, ролл с креветкой", weight: "750 г", price: 1742 }
    ]
  },
  {
