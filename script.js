...
const MENU = [
  ...
  },
  {
    ...
    items: [
      { id: "rl1", name: "Ролл «Креветка темпура острый»", desc: "Креветка темпура, творожный сыр, огурец, айсберг, морковь, икра тобико, стружка тунца, соусы спайси и унаги", weight: "280 г / 8 шт", price: 480 },
      ...
      { id: "rl3", name: "Ролл «Филадельфия»", desc: "Лосось, творожный сыр, огурец, авокадо, кунжут", weight: "270 г / 8 шт", price: 680 },
      { id: "rl4", name: "Ролл «Калифорния»", desc: "Крабовые палочки, творожный сыр, огурец, авокадо, икра тобико", weight: "260 г / 8 шт", price: 490 },
  ...
  },
  {
    ...
    items: [
      { id: "tp1", name: "Темпура с сурими", desc: "Сурими в хрустящей панировке, огурец, творожный сыр, морковь, айсберг, икра тобико, соусы спайси и унаги", weight: "285 г / 8 шт", price: 480 },
  ...
  },
  {
    ...
    items: [
      { id: "bk1", name: "Запечённый с лососем", desc: "Лосось, творожный сыр, огурец, сурими, айсберг, морковь, икра тобико, томат, зелёный лук, сыр гауда, сырный соус, соус унаги", weight: "300 г / 8 шт", price: 580 },
      { id: "bk2", name: "Запечённый с курицей", desc: "Курица, творожный сыр, огурец, сурими, айсберг, морковь, икра тобико, томат, зелёный лук, сыр гауда, сырный соус, соус унаги", weight: "300 г / 8 шт", price: 550 }
    ]
  },
  {
    cat: "maki", catLabel: "Маки", glyph: "🍙",
    items: [
      { id: "mk1", name: "Маки с лососем", desc: "Рис, нори, лосось", weight: "110 г", price: 280 },
      { id: "mk2", name: "Маки с чукой", desc: "Рис, нори, салат чука", weight: "110 г", price: 180 },
  ...
  },
  {
    ...
    items: [
      { id: "su1", name: "Суши с лососем", desc: "Рис для суши, нори, лосось", weight: "40 г", price: 160 },
      { id: "su2", name: "Суши с угрём", desc: "Рис для суши, нори, угорь, соус унаги, кунжут", weight: "40 г", price: 180 },
      { id: "su3", name: "Гункан с лососем", desc: "Рис, нори, лосось, соус спайси", weight: "45 г", price: 160 },
      { id: "su4", name: "Гункан с чукой", desc: "Рис, нори, салат чука, ореховый соус", weight: "45 г", price: 90 }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      { id: "se1", name: "Сет «Классика»", desc: "Калифорния, Филадельфия, маки с огурцом, маки с лососем", weight: "750 г", price: 1450 },
      { id: "se2", name: "«Любимый сет»", desc: "Запечённый с лососем, темпура с курицей, маки с огурцом, маки с лососем", weight: "805 г", price: 1150 },
      ...
      { id: "se4", name: "Сет «Ассорти»", desc: "Филадельфия, Калифорния, креветка темпура острый, темпура с курицей", weight: "1095 г", price: 1690 },
      { id: "se5", name: "Сет «Вкусняшка»", desc: "Запечённый с курицей, Филадельфия, ролл «Классический»", weight: "860 г", price: 1400 }
    ]
  }
];
