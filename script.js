...
/* ==========================================================
   МЕНЮ — данные блюд
   Цены — ориентировочные (проставлены на глаз), замените на
   реальные, когда они будут известны.
...
const MENU = [
  {
    ...
    items: [
      { id: "ap1", name: "Хрустящие креветки", desc: "Креветки в кляре карри, панировочные сухари, соус унаги и соус спайси", weight: "185 г", price: 320 }
    ]
  },
  {
    cat: "rolls", catLabel: "Роллы", glyph: "🍣",
    items: [
      { id: "rl1", name: "Ролл «Креветка темпура острый»", desc: "Креветка темпура, творожный сыр, огурец, айсберг, морковь, икра тобико, стружка тунца, соусы спайси и унаги", weight: "280 г / 8 шт", price: 430 },
      { id: "rl2", name: "Ролл с сёмгой и угрём", desc: "Сёмга, угорь, творожный сыр, огурец, айсберг, соус унаги, ореховый соус, кунжут", weight: "270 г / 8 шт", price: 460 },
      { id: "rl3", name: "Ролл «Филадельфия»", desc: "Лосось, творожный сыр, огурец, авокадо, кунжут", weight: "270 г / 8 шт", price: 400 },
      { id: "rl4", name: "Ролл «Калифорния»", desc: "Крабовые палочки, творожный сыр, огурец, авокадо, икра тобико", weight: "260 г / 8 шт", price: 360 },
      { id: "rl5", name: "Ролл «Классический»", desc: "Лосось, сурими, огурец, морковь, айсберг, творожный сыр, сыр чеддер, икра тобико, соусы спайси, ореховый и унаги, кунжут", weight: "290 г / 8 шт", price: 410 }
    ]
  },
  {
    cat: "tempura", catLabel: "Темпура-роллы", glyph: "🔥",
    items: [
      { id: "tp1", name: "Темпура с сурими", desc: "Сурими в хрустящей панировке, огурец, творожный сыр, морковь, айсберг, икра тобико, соусы спайси и унаги", weight: "285 г / 8 шт", price: 380 },
      { id: "tp2", name: "Темпура с лососем", desc: "Лосось в хрустящей панировке, огурец, творожный сыр, морковь, айсберг, икра тобико, соусы спайси и унаги", weight: "285 г / 8 шт", price: 420 },
      { id: "tp3", name: "Темпура с угрём", desc: "Угорь в хрустящей панировке, огурец, творожный сыр, морковь, айсберг, икра тобико, соусы спайси и унаги", weight: "285 г / 8 шт", price: 440 }
    ]
  },
  {
    cat: "baked", catLabel: "Запечённые роллы", glyph: "🧀",
    items: [
      { id: "bk1", name: "Запечённый с лососем", desc: "Лосось, творожный сыр, огурец, сурими, айсберг, морковь, икра тобико, томат, зелёный лук, сыр гауда, сырный соус, соус унаги", weight: "300 г / 8 шт", price: 440 },
      { id: "bk2", name: "Запечённый с курицей", desc: "Курица, творожный сыр, огурец, сурими, айсберг, морковь, икра тобико, томат, зелёный лук, сыр гауда, сырный соус, соус унаги", weight: "300 г / 8 шт", price: 390 }
    ]
  },
  {
    cat: "maki", catLabel: "Маки", glyph: "🍙",
    items: [
      { id: "mk1", name: "Маки с лососем", desc: "Рис, нори, лосось", weight: "110 г", price: 180 },
      { id: "mk2", name: "Маки с чукой", desc: "Рис, нори, салат чука", weight: "110 г", price: 150 },
      { id: "mk3", name: "Маки с сурими", desc: "Рис, нори, сурими", weight: "110 г", price: 140 },
      { id: "mk4", name: "Маки с угрём", desc: "Рис, нори, угорь, соус унаги, кунжут", weight: "110 г", price: 190 }
    ]
  },
  {
    cat: "sushi", catLabel: "Суши и гункан", glyph: "🍱",
    items: [
      { id: "su1", name: "Суши с лососем", desc: "Рис для суши, нори, лосось", weight: "40 г", price: 140 },
      { id: "su2", name: "Суши с угрём", desc: "Рис для суши, нори, угорь, соус унаги, кунжут", weight: "40 г", price: 160 },
      { id: "su3", name: "Гункан с лососем", desc: "Рис, нори, лосось, соус спайси", weight: "45 г", price: 130 },
      { id: "su4", name: "Гункан с чукой", desc: "Рис, нори, салат чука, ореховый соус", weight: "45 г", price: 120 }
    ]
  },
  {
    cat: "poke", catLabel: "Поке", glyph: "🥙",
    items: [
      { id: "pk1", name: "Поке с лососем", desc: "Лосось, рис, эдамаме, салат чука, ананас, томаты черри, маринованный огурец, ореховый соус, соус унаги, кунжутное масло", weight: "360 г", price: 480 },
      { id: "pk2", name: "Поке с креветками", desc: "Креветки в панко, рис, эдамаме, салат чука, ананас, томаты черри, маринованный огурец, ореховый соус, соус унаги, кунжутное масло", weight: "360 г", price: 510 }
    ]
  },
  {
    cat: "soups", catLabel: "Супы", glyph: "🍲",
    items: [
      { id: "sp1", name: "Суп «Том Ям»", desc: "Бульон на лемонграссе, лаймовых листьях и галанганe, креветки, мидии, кальмар, грибы, томаты черри, кинза; с рисом, чили и лаймом", weight: "515 г (суп 400 г + рис 100 г)", price: 420 }
    ]
  },
  {
    cat: "salads", catLabel: "Салаты", glyph: "🥗",
    items: [
      { id: "sl1", name: "Чука салат", desc: "Маринованные водоросли чука, ореховый соус, лимон", weight: "200 г", price: 280 }
    ]
  },
  {
    cat: "sets", catLabel: "Сеты", glyph: "🎉",
    items: [
      { id: "se1", name: "Сет «Классика»", desc: "Калифорния, Филадельфия, маки с огурцом, маки с лососем", weight: "750 г", price: 1250 },
      { id: "se2", name: "«Любимый сет»", desc: "Запечённый с лососем, темпура с курицей, маки с огурцом, маки с лососем", weight: "805 г", price: 1350 },
      { id: "se3", name: "Сет «Баланс Вкуса»", desc: "Запечённый с курицей, ролл «Классический», суши с лососем, гункан с чукой, суши с угрём, гункан с лососем", weight: "760 г", price: 1300 },
      { id: "se4", name: "Сет «Ассорти»", desc: "Филадельфия, Калифорния, креветка темпура острый, темпура с курицей", weight: "1095 г", price: 1750 },
      { id: "se5", name: "Сет «Вкусняшка»", desc: "Запечённый с курицей, Филадельфия, ролл «Классический»", weight: "860 г", price: 1450 }
    ]
  }
];
