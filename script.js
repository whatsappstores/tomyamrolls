...
const MENU = [
  ...
  },
  {
    ...
    items: [
      { id: "se1", name: "Сет «Классика»", desc: "Калифорния, Филадельфия, маки с огурцом, маки с лососем + Coca-Cola", weight: "750 г", price: 1655 },
      { id: "se2", name: "«Любимый сет»", desc: "Запечённый с лососем, темпура с курицей, маки с огурцом, маки с лососем + Coca-Cola", weight: "805 г", price: 1545 },
      { id: "se3", name: "Сет «Баланс Вкуса»", desc: "Запечённый с курицей, ролл «Классический», суши с лососем, гункан с чукой, суши с угрём, гункан с лососем + Coca-Cola", weight: "760 г", price: 1775 },
      { id: "se5", name: "Сет «Вкусняшка»", desc: "Запечённый с курицей, Филадельфия, ролл «Классический» + Coca-Cola", weight: "860 г", price: 1815 }
    ]
  },
  {
