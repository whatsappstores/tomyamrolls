...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sp2", name: "Суп «Том Ям» с лососем", desc: "Бульон на лемонграссе, лаймовых листьях и галанганe, лосось, креветки, мидии, кальмар, грибы, томаты черри, кинза; с рисом, чили и лаймом", weight: "715 г (суп 500 г + рис 140 г + чили 5 г + лайм 10 г)", price: 890 }
    ]
  },
  {
