...
const MENU = [
  ...
  },
  {
    ...
    items: [
      { id: "rl1", name: "Ролл «Креветка темпура острый»", desc: "Креветка темпура, творожный сыр, авокадо, икра тобико, стружка тунца, соусы спайси и унаги, перец чили", weight: "270 г / 8 шт", price: 600 },
